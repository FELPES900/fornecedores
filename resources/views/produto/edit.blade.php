                                ...
                                <div class="form-outline form-white mb-4">
                                    <div class="mb-3">
                                        ...
                                        <form class="form-horizontal" method="POST"
                                            action="{{ route('produtos.update', $produtos->id) }}">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <input type="text" class="form-control" id="fornecedores" name="name"
                                                placeholder="nome" value="{{ @$produtos->name }}">
                                            ...
                                            <label class="d-flex justifty-content-end form-label" for="typeEmailX">Valor
                                                do produto</label>
                                            ...
                                            <input type="text" class="form-control" id="descricao" name="descricao"
                                                placeholder="descrição" value="{{ @$produtos->descricao }}">
                                            <br>
